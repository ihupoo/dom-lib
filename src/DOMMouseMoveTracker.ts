...
class DOMMouseMoveTracker {
	...
	onMove
	onMoveEnd
	eventMoveToken: null | ReturnType<typeof on> = null
	eventUpToken: null | ReturnType<typeof on> = null
	moveEvent: null | MouseEvent = null
	deltaX = 0
	deltaY = 0
	x = 0
	y = 0
	 ...
	 */
	constructor(
		onMove: (x: number, y: number, e: MouseEvent) => void,
